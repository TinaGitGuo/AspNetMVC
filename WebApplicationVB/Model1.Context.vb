...
Partial Public Class CodeFirstDbDemoEntities
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=CodeFirstDbDemoEntities")
    End Sub
    ...
    Public Overridable Property BookMasters() As DbSet(Of BookMaster)
    ...
    Public Overridable Function sp_getTreeById(treeID As Nullable(Of Integer)) As ObjectResult(Of sp_getTreeById_Result)
        Dim treeIDParameter As ObjectParameter = If(treeID.HasValue, New ObjectParameter("TreeID", treeID), New ObjectParameter("TreeID", GetType(Integer)))

        Return DirectCast(Me, IObjectContextAdapter).ObjectContext.ExecuteFunction(Of sp_getTreeById_Result)("sp_getTreeById", treeIDParameter)
    End Function
